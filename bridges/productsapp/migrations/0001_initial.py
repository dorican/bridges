    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', imagekit.models.fields.ProcessedImageField(blank=True, default='products_images/default-product-image.png', upload_to=productsapp.models.material_image_upload_to, verbose_name='картинка материала')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', imagekit.models.fields.ProcessedImageField(blank=True, default='products_images/default-product-image.png', upload_to=productsapp.models.image_upload_to, verbose_name='картинка продукта')),
                ('alt_desc', models.CharField(blank=True, max_length=500, verbose_name='alt фотографии')),
                ('short_desc', models.TextField(blank=True, null=True, verbose_name='краткое описание материала')),
                ('description', models.TextField(blank=True, verbose_name='описание материала')),
                ('price', models.DecimalField(decimal_places=2, default=0, max_digits=8, verbose_name='цена')),
                ('created', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', imagekit.models.fields.ProcessedImageField(blank=True, default='products_images/default-product-image.png', upload_to=productsapp.models.work_image_upload_to, verbose_name='картинка материала')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('alt_desc', models.CharField(blank=True, max_length=128, verbose_name='alt фотографии')),
                ('image', imagekit.models.fields.ProcessedImageField(blank=True, default='products_images/default-work-image.png', upload_to=productsapp.models.work_image_upload_to, verbose_name='картинка материала')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material', models.ManyToManyField(blank=True, to='productsapp.Material', verbose_name='Применяемые материалы')),
                ...
                ('work', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='productsapp.Work', verbose_name='Вид работы')),
            ],
            options={
