Задача:
Необходимо разработать приложение Авторизации. В приложении 2 главные модели Пользователя и Компании, дополнительные
модели создать по необходимости. У пользователя должна быть возможность: авторизоваться на сайте и выйти,
зарегистрироваться, посмотреть свой профиль, изменить пароль, сбросить пароль. Реализовать функционал работы во
встроенной админке Джанго. Модель Компании реализовать только в админке. Написать unit-тесты.

==============================================================================================================

Репозитории:
Github-репозиторий проекта https://github.com/Djoongaar/bridges
